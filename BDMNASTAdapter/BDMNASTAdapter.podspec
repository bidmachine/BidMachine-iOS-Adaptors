Pod::Spec.new do |spec|
  ...
  spec.dependency "StackIAB/StackNASTKit", "~> #{networkVersion}"
  spec.dependency "StackIAB/StackRichMedia", "~> #{networkVersion}"
